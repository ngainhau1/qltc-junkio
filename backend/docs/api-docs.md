...
| Code | Mo ta |
| --- | --- |
| `200` | Thông tin người dùng hiện tại |
| `401` | Chưa đăng nhập hoặc token hết hạn |
...
| Truong | Kieu | Bat buoc | Mo ta |
| --- | --- | --- | --- |
| `avatar` | string | Co | File ảnh đại diện (JPEG/PNG, max 5MB) |
...
**Lấy danh sách khoản chia tiền đang chờ xử lý**
...
| Code | Mo ta |
| --- | --- |
| `200` | Danh sách khoản chia chờ xử lý |
...
| Tham so | Vi tri | Mo ta | Bat buoc | Kieu du lieu |
| --- | --- | --- | --- | --- |
| `shareId` | path | UUID của khoản chia tiền | Co | string (uuid) |
...
| Code | Mo ta |
| --- | --- |
| `200` | Đã chấp nhận khoản chia |
| `403` | Không có quyền duyệt khoản chia này |
| `404` | Không tìm thấy khoản chia (SHARE_NOT_FOUND) |
...
| Code | Mo ta |
| --- | --- |
| `200` | Đã từ chối khoản chia |
| `403` | Không có quyền từ chối khoản chia này |
| `404` | Không tìm thấy khoản chia (SHARE_NOT_FOUND) |
...
| `to_wallet_id` | string | Co | UUID ví người nhận |
...
**Dự báo thu/chi trong tương lai**
...
| Tham so | Vi tri | Mo ta | Bat buoc | Kieu du lieu |
| --- | --- | --- | --- | --- |
| `months` | query | Số tháng muốn dự báo (1-12) | Khong | integer [mac dinh: 3] |
