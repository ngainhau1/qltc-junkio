...
export function MainLayout() {
    ...
    return (
        <div className="min-h-screen bg-background relative">
            ...
            {/* Adds bottom padding on mobile to account for fixed bottom nav + floating FAB */}
            <main className="md:pl-64 pb-28 md:pb-8 min-h-screen transition-all duration-300">
                <Header />
